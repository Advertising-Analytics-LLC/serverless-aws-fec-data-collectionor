...
CREATE TABLE IF NOT EXISTS candidate_detail (
  ...
  candidate_inactive TINYINT(1) DEFAULT NULL,
  candidate_status VARCHAR(1) DEFAULT NULL,
  cycles JSON DEFAULT NULL,
  district VARCHAR(2) DEFAULT NULL,
  district_number INT DEFAULT NULL,
  election_districts JSON DEFAULT NULL,
  election_years JSON DEFAULT NULL,
  federal_funds_flag TINYINT(1) DEFAULT NULL,
  first_file_date DATE DEFAULT NULL,
  flags TEXT DEFAULT NULL,
  has_raised_funds TINYINT(1) DEFAULT NULL,
